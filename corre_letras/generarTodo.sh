...
sisa-ld -s -T system.lds corre_letras.o -o temp_corre_letras.o

#desensamblamos el codigo
sisa-objdump -d --section=.code temp_corre_letras.o >corre_letras.code
sisa-objdump -s --section=.data temp_corre_letras.o >corre_letras.data
...
sisa-ld -T system.lds corre_letras.o -o temp_corre_letras.o

sisa-objdump -S -x -w --section=.code temp_corre_letras.o >corre_letras.dis
sisa-objdump -S -x -w --section=.data temp_corre_letras.o >>corre_letras.dis

rm corre_letras.o temp_corre_letras.o corre_letras.code corre_letras.data
