...
sisa-ld -s -T system.lds fibonacci.o -o temp_fibonacci.o

#desensamblamos el codigo
sisa-objdump -d --section=.code temp_fibonacci.o >fibonacci.code
sisa-objdump -s --section=.data temp_fibonacci.o >fibonacci.data
...
sisa-ld -T system.lds fibonacci.o -o temp_fibonacci.o

sisa-objdump -S -x -w --section=.code temp_fibonacci.o >fibonacci.dis
sisa-objdump -S -x -w --section=.data temp_fibonacci.o >>fibonacci.dis

rm fibonacci.o temp_fibonacci.o fibonacci.code fibonacci.data
